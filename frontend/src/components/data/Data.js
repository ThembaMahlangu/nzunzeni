...
export const footer = [
  ...
  },
  {
    ...
    text: [{ list: "Privacy Policy" }, { list: "POPIA Act" }, { list: "T's & C's" }, { list: "Company Profile" },],
  },
  {
    title: "Business Solutions",
    text: [{ list: "Sponsors" }, { list: "Business Partners" }, { list: "Fair Practices" }, { list: "Affiliates" },],
  },
]
